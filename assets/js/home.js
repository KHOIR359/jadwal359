...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (const i in scheduleData) {
    ...
    let cards = createElementFromHTML(` <div class="col-12 col-sm-6 col-md-6 mb-4"> <div class="p-2 px-3 card shadow-sm" style="border-radius:15px;"> <div class="card-day fw-bold text-bebas-neue fs-3 text-grey mb-2"> ${i} </div> <div> <ul> </ul> </div> </div> </div>`);
